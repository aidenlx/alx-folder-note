...
import { App, TFile, TFolder, Modifier } from "obsidian";
import { basename, dirname } from "path";
import { ALxFolderNoteSettings, NoteLoc } from "settings";
...
export class NoteHandler {
  ...
  get settings(): ALxFolderNoteSettings {
  ...
  getAbstractFolderNote(folder: TFolder): {
    findIn: TFolder;
    noteBaseName: string;
  };
  getAbstractFolderNote(
  ...
  findFolderNote(findIn: TFolder, noteBaseName: string): TFile | null {
